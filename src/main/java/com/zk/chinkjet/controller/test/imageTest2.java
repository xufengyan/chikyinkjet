...
public class imageTest2 {
    ...
    public static void main(String[] args) throws IOException {
         String filename = "D:\\\\home/image/3.jpg";// separator是File里的一个常量,由于java历史遗留问题故为小写
...
//        imageTest2 i = new imageTest2();
//        i.setLucency(bufferedImage);
          ImageIO.write(bufferedImage, "jpg", new File("D:\\\\home/image/new44.jpg"));
    }
